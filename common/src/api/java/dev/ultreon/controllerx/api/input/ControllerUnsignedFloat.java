...
public enum ControllerUnsignedFloat implements IControllerInterDynamic<Float> {
    ...
    public float getValue() {
        return switch (this) {
            case LeftTrigger -> IControllerX.get().getInput().getAxis1(ControllerSignedFloat.LeftTrigger);
            case RightTrigger -> IControllerX.get().getInput().getAxis1(ControllerSignedFloat.RightTrigger);
            case LeftStickX -> (IControllerX.get().getInput().getAxis1(ControllerSignedFloat.LeftStickX) + 1) / 2;
            case LeftStickY -> (IControllerX.get().getInput().getAxis1(ControllerSignedFloat.LeftStickY) + 1) / 2;
            case RightStickX -> (IControllerX.get().getInput().getAxis1(ControllerSignedFloat.RightStickX) + 1) / 2;
            case RightStickY -> (IControllerX.get().getInput().getAxis1(ControllerSignedFloat.RightStickY) + 1) / 2;
    ...
    @Override
    public ControllerUnsignedFloat fromName(String text) {
        return EnumUtils.getEnum(ControllerUnsignedFloat.class, text);
    }
}
